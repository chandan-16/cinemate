...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=89161bb61fe0791ee95b3553e05c4421`)
  ...
  return (
    <main>
      <section className='flex justify-around flex-wrap py-5'>
        ...
        <div className='max-w-6xl text-gray-700 text-lg dark:text-white'>
          <h1 className='text-4xl font-bold my-3 3xl:text-left'>{movie.title}</h1>
